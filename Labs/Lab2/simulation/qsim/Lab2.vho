...
-- Design Ports Information
-- Divis3	=>  Location: PIN_B2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF D_SOP IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \inst4~0_combout\ = (\D~input_o\ & ((\C~input_o\ & (\A~input_o\ $ (\B~input_o\))) # (!\C~input_o\ & ((\B~input_o\) # (!\A~input_o\))))) # (!\D~input_o\ & ((\C~input_o\ & ((\A~input_o\) # (!\B~input_o\))) # (!\C~input_o\ & (\A~input_o\ $ (\B~input_o\)))))
